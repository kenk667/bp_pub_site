...
!(function(t, e) {
            ...
            return (
                ...
                (n._slide = function(t, n) {
                    ...
                    if (
                        ...
                        this._isSliding = !1;
                    else if (!this._triggerSlideEvent(h, r).isDefaultPrevented() &&
                        l &&
                        h
                    ) {
                        (this._isSliding = !0),
    ...
    function P(t) {
        ...
        for (
            var e = L(10) ? document.body : null, n = t.offsetParent || null; n === e && t.nextElementSibling;
            ...
            return (
                (n.show = function() {
                    ...
                    if (!(
                        ...
                        if (
                            (i && e(i).trigger(l),
                                e(this._element).trigger(c), !c.isDefaultPrevented() && !l.isDefaultPrevented())
                        ) {
                            r && (n = document.querySelector(r)),
